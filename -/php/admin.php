...
function inkblot_customize_register($customize) {
	...
	$customize->add_setting('content_width', array(
		...
		'description' => __('Defines the maximum pixel width for post content. <a href="https://codex.wordpress.org/Content_Width">Learn more at the WordPress Codex.</a>', 'inkblot'),
		'section' => 'inkblot_layout',
		'priority' => 35,
		'input_attr' => array(
			'min' => 0,
