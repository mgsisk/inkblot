...
<?php if ('one-column' !== get_theme_mod('content', 'one-column') or is_customize_preview()) : ?>
	...
	<div role="complementary" class="sidebar1 widgets columns-<?php print inkblot_count_widgets('primary-sidebar'); ?>" aria-label="<?php _e('Primary Sidebar', 'inkblot'); ?>">
		
		<?php if ( ! dynamic_sidebar('primary-sidebar') and current_user_can('edit_theme_options')) : ?>
			
			<aside role="complementary" class="widget">
...
<?php if (false !== strpos(get_theme_mod('content', 'one-column'), 'three-column') or is_customize_preview()) : ?>
	...
	<div role="complementary" class="sidebar2 widgets columns-<?php print inkblot_count_widgets('secondary-sidebar'); ?>" aria-label="<?php _e('Secondary Sidebar', 'inkblot'); ?>">
